...
typedef enum IIV_status {
	NOHASHFND,
	IMAGEOK,
	IMAGENOK,
} IIV_status;

void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_IIV_sample, (const char* str));
void SGX_UBRIDGE(SGX_NOCONVENTION, ocall_sha256_file, (char* path, char* outputBuffer, size_t len));
